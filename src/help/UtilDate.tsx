...
// const LANG = 'vi';
// const utcTimeString = Config.utcTimeString;
...
//   static formatDate = 'DD';

//   static weekdays = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'];
//   static monthNames = moment.months();
//   static monthShortNames = moment.monthsShort();
...
//     return dateTime instanceof Date && !isNaN(Number(dateTime));
//   }
...
//     dateTime:Date,
//     isUTC = UtilDate.DEFAULT_UTC,
//     undefinedString = defaultUndefined,
//   ) {
//     try {
//       if (
//         !UtilDate.isValid(dateTime) ||
...
//     dateTime:Date,
//     isUTC = UtilDate.DEFAULT_UTC,
//     stringFormatDate = UtilDate.formatDateLocal,
//   ) {
//     try {
...
//     }
//   }
//   static toTimeLocal(dateTime:Date, isUTC = UtilDate.DEFAULT_UTC) {
//     try {
...
//   static toCalendarLocal(dateTime:Date, isUTC = UtilDate.DEFAULT_UTC) {
//     try {
//       if (!UtilDate.isValid(dateTime)) {
//         return '';
//       }
...
//   // ******************************************************************************************************************************
//   // ******************************************************************************************************************************
//   static toDateUtc(dateTimeLocal:Date) {
//     try {
...
//   static toDateTimeUtc(dateTimeLocal:Date) {
//     try {
//       if (!UtilDate.isValid(dateTimeLocal)) {
//         return '';
//       }
...
//   static toDateTimeUtcStartDate(dateTimeLocal:any) {
//     try {
//       if (!UtilDate.isValid(dateTimeLocal)) {
//         return '';
//       }
...
//   static toDateTimeUtcEndDate(dateTimeLocal:any) {
//     try {
//       if (!UtilDate.isValid(dateTimeLocal)) {
//         return '';
//       }
...
//           999,
//         );
//         let startOfWeek = moment(startOfDay).add(
//           -1 * startOfDay.getDay() + 1,
//           'days',
//         );
...
//     let res = dateObj.toLocaleDateString(
//       language === 'vi' ? 'vi-VN' : 'en-US',
//       options,
//     );
...
//   static getCurrentDateString = (seperator = '/') => {
//     var today = new Date();
...
// export const parseUTC = (date, format = null) =>
//   moment(date).format(format ? format : utcTimeString);
